---
name: speckit-new-change
description: Start a new Speckit change using the experimental artifact workflow.
...
2. **Determine the workflow schema**
   ...
   **Use a different schema only if the user mentions:**
   ...
   - "show workflows" or "what workflows" → run `speckit schemas --json` and let them choose
...
5. **Get instructions for the first artifact**
   ...
   ```bash
   speckit instructions <first-artifact-id> --change "<name>"
   ```

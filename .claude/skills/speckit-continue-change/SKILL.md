---
name: speckit-continue-change
description: Continue working on an Speckit change by creating the next artifact.
...
1. **Select the change**
   ...
   Always announce: "Using change: <name>" and how to override (e.g., `/speckit:continue <other>`).

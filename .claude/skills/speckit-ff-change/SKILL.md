---
name: speckit-ff-change
description: Fast-forward through Speckit artifact creation - generate everything needed for implementation in one go.
...
- Prompt: "Run `/speckit:apply` or ask me to implement to start working on the tasks."
